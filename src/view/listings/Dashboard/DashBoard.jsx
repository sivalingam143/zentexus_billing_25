      ...
      <Container className="mt-1">
        <Row>
          <Col xl={12}>
              ...
              <Col md={6}>
                <Card className="border-light">
                  <Card.Body className="d-flex justify-content-between align-items-center">
                    <div>
                      <Card.Title className="mb-1" style={{ fontWeight: "600", fontSize: "0.95rem" }}>
                        Total Receivable
                      </Card.Title>
            ...
            {/* Total Sale Chart Section */}
            <Card className="mb-3">
              <Card.Body>
                <Row className="align-items-center mb-3">
                  <Col>
                    <Card.Title style={{ fontWeight: 600, marginBottom: 0 }}>Total Sale</Card.Title>
                  ...
                  <Col md="auto">
                    <Dropdown>
                      ...
                      <Dropdown.Menu>
                        <Dropdown.Item href="#this-month">This Month</Dropdown.Item>
                        <Dropdown.Item href="#last-month">Last Month</Dropdown.Item>
                        <Dropdown.Item href="#this-year">This Year</Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                  </Col>
                </Row>
                ...
                <div style={{ height: "200px", position: "relative" }}>
                  ...
                  <svg width="100%" height="200px" style={{ display: "block" }}>
                    ...
                    {[1, 4, 7, 10, 13, 16, 19, 22, 25, 28].map((day, idx) => {
                      ...
                      return (
                        <g key={day}>
                          <line x1={x} y1="190" x2={x} y2="185" stroke="#ccc" strokeWidth="1" />
                          <text x={x} y="205" fontSize="8" fill="#666" textAnchor="middle">
                            {day} Nov
                          </text>
                        </g>
                      );
                    ...
                    {[0, 200, 400, 600, 800, 1000].map((val, idx) => {
                      ...
                      return (
                        <g key={val}>
                          <line x1="40" y1={y} x2="340" y2={y} stroke="#eee" strokeWidth="1" />
                          <text x="25" y={y + 4} fontSize="8" fill="#666" textAnchor="end">
                            {val === 0 ? "" : val}
                          </text>
                        </g>
                      );
            ...
            <Card>
              <Card.Body>
                <Row className="mb-3 align-items-center">
                  <Col>
                    <h6 style={{ marginBottom: 0, fontWeight: 600 }}>Most Used Reports</h6>
                  </Col>
                  <Col md="auto">
                ...
                <Row className="g-3">
                  {["Sale Report", "All Transactions", "Daybook Report", "Party Statement"].map((report, idx) => (
                    <Col key={idx} xs={12} sm={6} md={3}>
                      <Button variant="outline-primary" className="w-100 d-flex justify-content-between align-items-center" style={{ borderRadius: "8px", fontWeight: 600 }}>
                        {report} <span>{">"}</span>
                      </Button>
                    </Col>
                  ))}
