...
const DeluxeCreation = ({ schema, formData, setFormData }) => {
  ...
  // Prepare staff options for the dropdown with a filter for "டிலெஸ் பின்னல்" staff
  ...
  const handleInputChange = (e, fieldName) => {
    ...
    setCurrentProduct((prev) => {
      ...
      if (fieldName === "product_name" && Product.length > 0) {
        ...
        if (selectedProduct) {
          updatedProduct.per_cooly_rate =
            selectedProduct.deluxe_Knitting_wage || "";
        }
      }
